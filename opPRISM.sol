 ...
 *
 * Attributes:
 * - Supports minting by the opBridge
 * - Supports burning by the opBridge
 * - Contains a 0.25% transaction fee automatically sent to the opBridge
 */
contract opPRISM is SatellitePRISM {
    constructor() SatellitePRISM("Optimistic PRISM Token", "opPRISM") public {
    }
}
