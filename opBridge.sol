 ...
 *
 * Attributes:
 * - Mints opPRISM tokens from an authorized member after a cross-chain migration
 * - Burns opPRISM tokens from the bridge and emits a cross-chain fee migration event
 */
contract opBridge is SatelliteMultiBridge {
    constructor(ISatellitePRISM opPRISM, uint256[] memory chainList) SatelliteMultiBridge(opPRISM, chainList) public {
    }
}
